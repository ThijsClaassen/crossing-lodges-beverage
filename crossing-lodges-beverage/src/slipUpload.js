...
// bev_purchases.slip_id column was already added by that same migration,
// this is just the first time Beverage's own UI actually uses it).
//
// Returns the new purchase_slips row, whose `id` is the slip_id to stash on
// whichever bev_purchases row(s) this photo covers — several rows can share
// one slip_id when one delivery note has several line items.
import { supabase } from './supabaseClient.js'
import { sb } from './sb.js'

const APP_NAME = 'beverage'
